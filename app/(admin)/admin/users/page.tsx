...
import { Search, ShieldCheck, Ban, RotateCcw, Filter, Loader2 } from "lucide-react";
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Search accounts, review permissions, and manage verification status.
          </p>
        </div>
                  ...
                  {users.map((user) => {
                    ...
                    return (
                      <tr key={user.id}>
                        ...
                        <td className="px-4 py-3">
                          <Badge variant={!isActive ? "destructive" : isVerified ? "success" : "warning"}>
                            {!isActive ? "Suspended" : isVerified ? "Verified" : "Pending"}
                          </Badge>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
